"""
LightGBM regression using an input CSV file provided at runtime.

Usage:
    python pavement_light_gbm.py Data_Texas_No_Missing.csv
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and evaluate a LightGBM regression model using a pavement CSV file."
    )
    parser.add_argument(
        "csv_file",
...
# -----------------------------
# parameter starting from XGBoost
